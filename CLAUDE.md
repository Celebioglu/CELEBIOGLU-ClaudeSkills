...
- **Plugin manifest:** `markdown-html-skills` plugin.json `skills` array now lists 5 paths (orchestrator + design-system + md-document + md-review + md-slides). Marketplace counters updated (trued up 2026-06-10 via `scripts/derive_counters.py`): 77 plugins, 17 domains, **346 skills**, **584 Python tools**, **701 references**, **99 slash commands**.
...
**Version:** v2.10.3
**Status:** 346 skills deployed across 17 domains, 77 marketplace plugins, docs site live (counters derived via `scripts/derive_counters.py`)
